...
ActiveRecord::Schema.define(:version => 20131009003432) do
  ...
  add_index "statuses", ["twitter_user_id", "twitter_status_id"], :name => "index_statuses_on_twitter_user_id_and_twitter_status_id"
